...
public class Adicao {
	...
	public static void main(String[] args) {
		...
		int numero01;//variável que recebrá o primeiro numero
		int numero02;//variável que recebrá o segundo numero
		int sum;//recebe a soma dos dois valores;
		
		System.out.println("Insira o primeiro número: ");//entrada
		numero01 = entrada.nextInt();
		
		System.out.println("Insira o segundo número: ");//entrada

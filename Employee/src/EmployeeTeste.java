...
public class EmployeeTeste {
	...
	public static void main(String[] args) {
		...
		String salario01 = JOptionPane.showInputDialog("Informe seu salário:");
			double conversao01 = Double.parseDouble(salario01);
			employee01.setSalario(conversao01);
					String mensagem01 = String.format("Nome: %s%n Sobrenome: %s%n Salário anual: %.2f%n Aumento de 10 por cento: %s",employee01.getNome(), employee01.getSobrenome(), (employee01.getSalario()*12), ((employee01.getSalario()*12)+((employee01.getSalario()*12)*10/100)));
		...
		String salario02 = JOptionPane.showInputDialog("Informe seu salário:");
			double conversao02 = Double.parseDouble(salario02);
			employee02.setSalario(conversao02);
					String mensagem02 = String.format("Nome: %s%n Sobrenome: %s%n Salário anual: %.2f%n  Aumento de 10 por cento: %s", employee02.getNome(), employee02.getSobrenome(), (employee02.getSalario()*12), ((employee02.getSalario()*12)+((employee02.getSalario()*12)*10/100)));
